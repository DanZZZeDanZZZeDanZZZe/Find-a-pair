...
import {createMenu, addLevelHolder, createHighscoreTable, formAContainerOfBlocks, healthIndcator} from './view'
import {menuData, gameLevelConfiguration} from './data'
import {hasClass, removeElementById, swapId, closeWindow, removeChilds, getId} from './utils'
